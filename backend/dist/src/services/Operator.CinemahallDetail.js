...
export var getCinemhalldetail = /*#__PURE__*/ function() {
    "use strict";
    function getCinemhalldetail() {
        _class_call_check(this, getCinemhalldetail);
    }
    _create_class(getCinemhalldetail, [
        {
            key: "getcinemhallDetail",
            value: function getcinemhallDetail(operatorId) {
                return _async_to_generator(function() {
                    var cinemahalldetail, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                cinemahalldetail = _state.sent();
                                if (!cinemahalldetail) {
                                    return [
                                        2,
                                        "no cinemahall found for this operator"
                                    ];
                                }
                                return [
                                    2,
        ...
        {
            key: "getCinemhallMovie",
            value: function getCinemhallMovie(operatorId) {
                return _async_to_generator(function() {
                    var cinemahall, moviesInCinemaHall, movies, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
