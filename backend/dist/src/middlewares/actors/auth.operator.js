...
export var OperatorMiddleware = /*#__PURE__*/ function() {
    ...
    function OperatorMiddleware() {
        _class_call_check(this, OperatorMiddleware);
    }
    _create_class(OperatorMiddleware, null, [
        {
            key: "isOperator",
            value: function isOperator(req, res, next) {
                        ...
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                if (!operator) {
                                    return [
                                        2,
                                        res.status(401).send("Unauthorized: Operator not found")
                                    ];
                                }
