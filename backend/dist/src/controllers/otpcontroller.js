...
export var sendOtpTophone = function() {
    var _ref = _async_to_generator(function(req, res) {
        var mobile, token, error;
    ...
    return function sendOtpTophone(req, res) {
        return _ref.apply(this, arguments);
    };
}();
export var verifyOtp = function() {
    var _ref = _async_to_generator(function(req, res) {
        var _req_body, token, otp, result, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    _state.trys.push([
                    ...
                    _req_body = req.body, token = _req_body.token, otp = _req_body.otp;
                    if (!token || !otp) {
                        return [
                            2,
                            res.status(400).json({
    ...
    return function verifyOtp(req, res) {
        return _ref.apply(this, arguments);
    };
}();
