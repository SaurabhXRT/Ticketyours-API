...
export var addCity = function() {
    var _ref = _async_to_generator(function(req, res) {
        var _req_body, name, state, citydetail, service, existingcity, response, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    _req_body = req.body, name = _req_body.name, state = _req_body.state;
                    if (!name || !state) {
                        return [
                            2,
                            res.status(400).json({
                ...
                case 1:
                    ...
                    return [
                        4,
                        service.checkexistingcity(citydetail.name)
                    ];
                case 2:
    ...
    return function addCity(req, res) {
