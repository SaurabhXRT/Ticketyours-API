...
export var register = function() {
    var _ref = _async_to_generator(function(req, res) {
        var body, adminCredentials, existingUser, hashedPassword, user, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    return [
                        4,
                        service.get(adminCredentials.phone)
                    ];
                case 2:
                    ...
                    return [
                        4,
                        service.hashPassword(adminCredentials.password)
                    ];
                case 3:
                    ...
                    return [
                        4,
                        service.create(adminCredentials)
                    ];
                case 4:
                    user = _state.sent();
                    res.status(200).json({
