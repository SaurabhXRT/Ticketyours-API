...
var service = new GetScreenService();
export var getscreen = function() {
    var _ref = _async_to_generator(function(req, res) {
        var cinemaHallId, screen, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    return [
                        4,
                        service.getscreen(cinemaHallId)
                    ];
                case 2:
                    screen = _state.sent();
                    if (!screen) {
    ...
    return function getscreen(req, res) {
