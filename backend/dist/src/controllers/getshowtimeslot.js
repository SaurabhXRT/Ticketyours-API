...
export var getShowtimesbyMovieIdAndCityId = function() {
    var _ref = _async_to_generator(function(req, res) {
        var _req_params, movieId, cityId, response, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    return [
                        4,
                        newshotimeservice.getAvailableShowtimesWithDefault(movieId, cityId)
                    ];
                case 2:
...
export var getShowtimesBySelecteddateAndScreentype = function() {
    var _ref = _async_to_generator(function(req, res) {
        var _req_params, movieId, cityId, _req_body, selectedDate, selectedScreenType, response, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    // #swagger.description = 'get all showtimes with cinemahalls for selecxtedate and screentype query'
                    _req_params = req.params, movieId = _req_params.movieId, cityId = _req_params.cityId;
                    _req_body = req.body, selectedDate = _req_body.selectedDate, selectedScreenType = _req_body.selectedScreenType;
                ...
                case 1:
                    ...
                    return [
                        4,
                        newshotimeservice.getCinemaHallsWithShowtimes(movieId, cityId, selectedDate, selectedScreenType)
                    ];
                case 2:
                    response = _state.sent();
    ...
    return function getShowtimesBySelecteddateAndScreentype(req, res) {
        return _ref.apply(this, arguments);
    };
}();
