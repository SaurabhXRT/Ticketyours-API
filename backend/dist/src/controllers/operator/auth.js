...
export var register = function() {
    var _ref = _async_to_generator(function(req, res) {
        var body, operatorCredentials, existingUser, hashedPassword, user, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    return [
                        4,
                        service.get(operatorCredentials.phone)
                    ];
                case 2:
                    ...
                    return [
                        4,
                        service.hashPassword(operatorCredentials.password)
                    ];
                case 3:
                    ...
                    return [
                        4,
                        service.create(operatorCredentials)
                    ];
                case 4:
                    user = _state.sent();
                    res.status(200).json({
...
export var login = function() {
    var _ref = _async_to_generator(function(req, res) {
        var body, userCredentials, user, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                ...
                case 1:
                    ...
                    return [
                        4,
                        service.loginWithPassword(userCredentials)
                    ];
                case 2:
                    user = _state.sent();
