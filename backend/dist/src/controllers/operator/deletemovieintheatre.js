...
var service = new DeleteMovieService();
export var deleteMovieFromCinemaHall = function() {
    var _ref = _async_to_generator(function(req, res) {
        var _req_body, movieInTheatreId, cinemaHallId, cityId, result, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    // #swagger.description = 'delete the adedd movie in a cinemahall'
                    _req_body = req.body, movieInTheatreId = _req_body.movieInTheatreId, cinemaHallId = _req_body.cinemaHallId, cityId = _req_body.cityId;
                ...
                case 1:
                    ...
                    return [
                        4,
                        service.deleteMovie(movieInTheatreId, cinemaHallId, cityId)
                    ];
                case 2:
                    result = _state.sent();
    ...
    return function deleteMovieFromCinemaHall(req, res) {
