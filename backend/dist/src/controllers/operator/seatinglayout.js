...
var service = new SeatingArrangementService();
export var CreateSeatingLayout = function() {
    var _ref = _async_to_generator(function(req, res) {
        var _req_body, cinema_hall_id, seatConfigurations, newSeatingArrangement, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    _req_body = req.body, cinema_hall_id = _req_body.cinema_hall_id, seatConfigurations = _req_body.seatConfigurations;
                ...
                case 1:
                    ...
                    return [
                        4,
                        service.createSeatingArrangement(cinema_hall_id, seatConfigurations)
                    ];
                case 2:
                    newSeatingArrangement = _state.sent();
                    res.status(201).json({
    ...
    return function CreateSeatingLayout(req, res) {
